...
<div id="wrapper">
    ...
    <main>
        ...
        Cette requete vous est donnée, elle est complexe mais correcte, si vous ne la comprenez pas c'est normal, passez, on y reviendra */
        $laQuestionEnSql = "
        ...
        <?php // avec le <?php ci-contre on retourne en mode php 
